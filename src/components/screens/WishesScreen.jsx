  ...
  return (
    ...
    >
        ...
        {WISHES.map((w, i) => (
          <motion.div key={i}
            ...
            <motion.span
              ...
              style={{ fontSize: 'clamp(1.2rem, 4vw, 1.6rem)', minWidth: 28 }}>{w.emoji}</motion.span>
      ...
      <motion.div className="glass-strong" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.9 }}
        style={{ maxWidth: 400, width: '100%', padding: 'clamp(14px, 3vw, 18px) clamp(16px, 4vw, 22px)', textAlign: 'center', flexShrink: 0 }}>
        <p style={{
